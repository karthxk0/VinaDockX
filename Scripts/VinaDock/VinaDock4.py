...
======================================================================                                                       
  ...
  > Version 2.4  |  > Built by karthxk (https://karthxk0.github.io/)         
...
def get_vina_executable():
    ...
    if sys.platform.startswith('win'):
        ...
        vina_path = os.path.join(base_dir, 'vina-linux', 'vina')
        os_type = "Linux"
...
def generate_merged_log(log_files, output_dir, receptor_name, merge_filename, mode_str, search_space_full):
    ...
    with open(merged_path, 'w') as out_f:
        out_f.write("# Generated by VinaDock.py v2.4\n")
...
def main():
    ...
    if merge_logs and len(generated_logs) > 1:
        ...
        generate_merged_log(generated_logs, out_dir, receptor_base, merged_log_name, mode_str, search_space_full)
    ...
    print(f"\n{C.GREEN}All files have been saved to:{C.RESET} {os.path.abspath(out_dir)}")
    print(f"{C.BOLD}{C.MAGENTA}======================================================={C.RESET}\n")
